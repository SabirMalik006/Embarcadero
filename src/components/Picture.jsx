...
const Picture = () => {
  return (
    <div
    className="flex flex-col justify-center items-center mt-40 px-[40px] py-26 text-center max-w-8xl mx-auto  relative"
    style={{
  ...
  >
      ...
      <div className="mb-10  relative z-10">
        <h2 className="text-[32px] sm:text-[40px]  xl:text-5xl font-semibold xl:font-bold leading-snug">
          Get RAD{" "}
          <span
        ...
        <p className="text-gray-600 font-normal text-[20px] sm:text-[20px] xl:text-2xl tracking-wide mt-4">
