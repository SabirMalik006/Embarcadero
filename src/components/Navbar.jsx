    ...
    <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-[60px] md:px-[40px] 2xl:px-[150px]  ">
      ...
      <div className="w-full overflow-hidden">
        <div className="flex items-center justify-between mt-4">
          ...
          <div className="hidden md:flex lg:hidden items-center gap-4 ml-auto px-4 py-2 overflow-hidden">
            {/* Sign In */}
            ...
            <button
              ...
              "
            >
              <a href="" className="text-sm font-medium">Buy Now</a>
            </button>
            ...
            <button
              ...
              "
            >
              <a href="" className="text-sm font-medium">Free Trial</a>
            </button>
          </div>
      ...
      <div className="faq flex flex-col md:flex-row justify-between mt-8 font-medium items-center space-y-2 md:space-y-0 w-full">
        <div className="names flex gap-2 md:gap-3 items-center flex-wrap px-4 md:px-0 z-55">
          ...
          <span className="text-gray-400 text-sm inline-block scale-x-50">&gt;&gt;</span>
          <p className="text-sm font-medium">Products</p>
          <span className="text-gray-400 text-sm inline-block scale-x-50">&gt;&gt;</span>
          <p className=" text-red-500 text-sm font-medium">RAD Studio</p>
        </div>
        <div className="questions z-57 flex gap-1 flex-wrap items-center justify-center px-4 md:px-0">
          <a href="#" className="flex items-center relative text-sm leading-none">
            <span className="absolute bottom-[0px] left-0 w-full border-b border-gray-600"></span>
            <span className="relative">What's New?</span>
          </a>
          <p className="text-gray-500">-</p>
          <a href="#" className="flex items-center relative text-sm leading-none">
            <span className="absolute bottom-[0px] left-0 w-full border-b border-gray-600"></span>
            <span className="relative">Product Edition</span>
          </a>
          <p className="text-gray-500">-</p>
          <a href="#" className="flex items-center relative text-sm leading-none">
            <span className="absolute bottom-[0px] left-0 w-full border-b border-gray-600"></span>
            <span className="relative">Previous Version</span>
          </a>
          <p className="text-gray-500">-</p>
          <a href="#" className="flex items-center relative text-sm leading-none">
            <span className="absolute bottom-[0px] left-0 w-full border-b border-gray-600"></span>
